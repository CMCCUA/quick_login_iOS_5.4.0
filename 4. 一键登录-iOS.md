...
3. 添加bundle资源包 TARGETS -->Build Phases -->Copy Bundle Resources --> 点击 "+" --> Add Other --> TYRZSDK.frameWork --> Resource.bundle -->Open 即可
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    // Override point for customization after application launch.
     [TYRZUILogin initializeWithAppId:APPID appKey:APPKEY resumeObject:self catchException:YES];
    return YES;
}
```
...
用于初始化appid、appkey、场景上下文对象和异常捕获设置。
此方法必须要在Appdelegate调用

**原型**

```objective-c
+ (void)initializeWithAppId:(NSString *)appId appKey:(NSString *)appKey resumeObject:(id)resumeObj catchException:(BOOL)flag;
```
...
```
{
    ...
    resultCode = 103000;
    token = ;
}
```
...
{
    "body" : {
        "token" : "",
    },
    "header" : {
        "appid" : "10000003",
        "apptype" : "5",
        "msgid" : "129c4a2dc1024d8fbff5dcfdc370eea5",
        "sign" : "",
        "strictcheck" : "0",
        "systemtime" : "20180131191938225",
        "version" : "1.0",
    }
}
```
...
```
{
    "body" : {
       "authtime" : "2018-05-31 19:29:50",
        ...
        "usessionid" : "QjdDMkUwRDY1MkQyNUVBNkE2@http://120.197.235.27:8080/test/@01",
    },
    "header" :     {
        "inresponseto" = "e0480ff891854fc9a481bed41bc5f14a",
        "resultcode" = "103000",
        "systemtime" = "20180531193023731",
        "version" = "1.0",
    }
}
```
